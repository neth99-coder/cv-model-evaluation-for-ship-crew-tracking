"""ByteTrack person tracker using Ultralytics YOLO track mode."""
...
class ByteTrackTracker(BasePersonTracker):
    ...
    def reset(self) -> None:
        # Recreate predictor/tracker state for each new video sequence.
