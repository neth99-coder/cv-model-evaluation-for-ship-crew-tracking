...
const FRAMEWORK_DESC = {
  boxmot:
    "Unified tracker library supporting ByteTrack, BoT-SORT, OC-SORT, Deep OC-SORT, StrongSORT with YOLOv8/11/26 and other detectors",
  fairmot:
    "Joint detection & embedding model — built-in Re-ID with DLA34/HRNet/ResNet50 backbone",
  deepsort:
    "Classic DeepSORT with pluggable YOLOv8/11/26/v5 detector and configurable Re-ID model",
};
